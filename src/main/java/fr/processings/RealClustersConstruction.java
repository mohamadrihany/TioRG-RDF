...
public class RealClustersConstruction {
    ...
    public static ArrayList<Graph> main(Graph<RDFNode, Statement> globalGraph, ArrayList<Graph> clusterList, ArrayList<PairSourceSet> listResourceRDFNodes) {
    ...
    public static ArrayList<Graph> clusterListWithRealResources(Graph<RDFNode, Statement> globalGraph, ArrayList<Graph> clusterList, ArrayList<PairSourceSet> listResourceRDFNodes) {
        ArrayList<Graph> finalClusterList = new ArrayList<>();
    ...
    public static ArrayList<RDFNode> getRessourcesSet(ArrayList<PairSourceSet> pairs, RDFNode node) {
        ArrayList<RDFNode> realRessourcesList = new ArrayList();
        for (PairSourceSet pair : pairs) {
