...
import fr.search.LuceneSearch.PairLuceneScore;
import fr.search.ResultConstruction.ResultNodeModel;
...
public class Ranking {
    ...
    public static ArrayList<TupleResultScore> main(ArrayList<ResultNodeModel> resultList, PairLuceneScore pairLuceneScore, Element racine) throws Exception {
        ArrayList<TupleResultScore> finalResult = new ArrayList<>();
        float minScore = 100.0f;
          float maxScore = 0.0f;
 for (ResultNodeModel result : resultList) {
    ...
    public static class TupleResultScore {
        ...
        ResultNodeModel Result;
        float Score;

        public ResultNodeModel getResult() {
            return Result;
        }
        ...
        public TupleResultScore(ResultNodeModel result, float score) {
            Result = result;
            Score = score;
        }
    }
