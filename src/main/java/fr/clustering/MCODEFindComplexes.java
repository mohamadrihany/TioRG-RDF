...
import fr.clustering.MCODEVertexWeiting.PairNodeWeight;
...
public class MCODEFindComplexes {
     ...
     */
    private void FindComplex(ArrayList<PairNodeWeight> nodesWeight, double vwp, Hashtable seens, RDFNode s, Collection<RDFNode> cluster, ArrayList<MCODEVertexWeiting.TupleNodeInternNeighbor> nodesNeighborWithoutLiterraux, double weightS) {
