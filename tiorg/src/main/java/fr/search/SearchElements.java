...
import fr.search.UsingPatternsNodes.TwoReleventFragment;
...
//        System.out.println();
        ...
        for (ScoreDoc scoredoc : scoreDocArray) {
            ...
            if (!"edge".equals(doc.getField("type").stringValue())) {
                ...
                TwoReleventFragment relevent = UsingPatternsNodes.main(doc.getField("uri").stringValue(), doc.getField("type").stringValue(), doc.getField("content").stringValue(), doc.getField("property").stringValue(), model, racine, graph);
                ArrayList<TypeReleventFragment> releventFragments = relevent.ReleventFragment;
                ArrayList<TypeReleventFragment> releventFragmentModel = relevent.ReleventFragmentModel;
...
//urielement and TypeElement are for the element before patterns (l'element de recuperation)
    ...
    public static class ElementReleventFragmentNodes {
         ...
         *
         */
        public ElementReleventFragmentNodes(ArrayList<TypeReleventFragment> releventFragment, String uRIelement, String typeElement, ArrayList<TypeReleventFragment> releventFragmentModel, ArrayList<Model> listModel) {
