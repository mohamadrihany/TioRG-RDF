...
public class PreprocessingFrame extends javax.swing.JDialog
{
	 ...
	 * javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
	 * javax.swing.GroupLayout.PREFERRED_SIZE) .addGap(7, 7, 7))); fr.views.PredicateTable
	 * predicatesPanelValorisation = new fr.views.PredicateTable(true);
	 ...
	 * tableModel.addRow(column.toArray()); } } fr.views.PredicateTable predicatesPanelPartage = new
	 * fr.views.PredicateTable(false); JScrollPane clustersList = (JScrollPane)
