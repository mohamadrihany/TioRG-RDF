...
public class MDIDesktopPane extends JDesktopPane
{
	...
	public ArrayList<JInternalFrame> getFramesLikeName(String name)
	{
		ArrayList<JInternalFrame> list = new ArrayList<JInternalFrame>();
		for(JInternalFrame frame : getAllFrames())
		{
			if( frame.getName().toUpperCase().startsWith(name.toUpperCase()) )
				list.add(frame);
		}
		if( !list.isEmpty() )
			return list;
	...
	public ArrayList<JInternalFrame> getFramesLikeTitle(String name)
	{
		ArrayList<JInternalFrame> list = new ArrayList<JInternalFrame>();
		for(JInternalFrame frame : getAllFrames())
		{
			if( frame.getTitle().toUpperCase().startsWith(name.toUpperCase()) )
				list.add(frame);
		}
		if( !list.isEmpty() )
			return list;
