...
public class SearchWordNetHypo {
    ...
    public static String main(String keyword) {
        ...
        String querySelect = "SELECT * WHERE { <http://www.w3.org/2006/03/wn/wn20/instances/"+keyword+ ">  <http://www.w3.org/2006/03/wn/wn20/schema/hyponymOf> ?y}";   //x hypo y => y hyper x
